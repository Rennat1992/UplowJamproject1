...
public class WallAlpha3 : MonoBehaviour
{
    ...
    public static WallAlpha3 WallAlpha3Single;

    void Awake()
    {
        if (WallAlpha3Single == null)
        {
            DontDestroyOnLoad(gameObject);
            WallAlpha3Single = this;
        }
        else if (WallAlpha3Single != this)
        {
            Destroy(gameObject);
        }

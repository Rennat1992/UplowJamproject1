...
public class WallAlpha4 : MonoBehaviour
{
    ...
    public static WallAlpha4 WallAlpha4Single;

    void Awake()
    {
        if (WallAlpha4Single == null)
        {
            DontDestroyOnLoad(gameObject);
            WallAlpha4Single = this;
        }
        else if (WallAlpha4Single != this)
        {
            Destroy(gameObject);
        }
